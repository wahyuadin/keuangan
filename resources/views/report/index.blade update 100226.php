                ...
                <table id="example" class="table table-striped table-bordered w-100 mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endphp
                            <td>Rp {{ number_format($dataItem->sla->rkap ?? 0, 0, ',', '.') }}</td>
                            {{-- januari --}}
                            <td>Rp {{ number_format($dataItem->januari ?? 0, 0, ',', '.') }}</td>
                            <td>Rp {{ number_format($dataItem->januari_selisih ?? 0, 0, ',', '.') }}</td>
                            <td>Rp {{ number_format( (($dataItem->januari ?? 0) - ($dataItem->januari_selisih ?? 0)), 0, ',', '.') }}</td>
                            ...
                            <td>Rp {{ number_format( (($dataItem->februari ?? 0) - ($dataItem->februari_selisih ?? 0)), 0, ',', '.') }}</td>
                            ...
                            <td>Rp {{ number_format( (($dataItem->maret ?? 0) - ($dataItem->maret_selisih ?? 0)), 0, ',', '.') }}</td>
