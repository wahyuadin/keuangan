        ...
        <div class="card-body">
            <div class="row">
                <div class="col-6 col-md-8">
                    <h5 class="card-title">Data Daftar Penetapan RKAP</h5>
                </div>
            </div>
            <div class="table-responsive mt-3">
                <div class="mt-3 mb-4">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRkap">
                ...
                <table id="example" class="table table-striped table-bordered w-100 mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $dataItem->jumlah ? 'Rp ' . number_format($dataItem->jumlah, 0, ',', '.') : '-' }}</td>
                            @php
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editRkap{{ $dataItem->id }}">
                                        Edit
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteRkap{{ $dataItem->id }}">
                                        Delete
                                    </button>
                                </div>
                            </td>
...
@include('rkap.modal.add')
@include('rkap.modal.edit')
@include('rkap.modal.delete')
@push('style')
{{-- datatable --}}
